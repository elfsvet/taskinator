...
// empty tasks array to store objects of tasks
var tasks = [];
...
var createTaskEl = function (taskDataObj) {
    ...
    listItemEl.className = 'task-item'; // add task id as a custom attribute
    listItemEl.setAttribute("data-task-id", taskIdCounter); //create div to hold task info and add to list item

    var taskInfoE1 = document.createElement('div');
    taskInfoE1.className = 'task-info';     // give it a class name
    taskInfoE1.innerHTML = // add html content to div
    ...
    // saves array to the localStorage
    saveTasks();
...
var taskButtonHandler = function (event) {
    ...
    if (targetEl.matches(".edit-btn")) {   // edit button was clicked

        var taskId = targetEl.getAttribute("data-task-id");// get the element's task id
        editTask(taskId);
    } else if (targetEl.matches(".delete-btn")) { // delete button was clicked
